  ...
  public: {
    Tables: {
      ...
      agenda_tarefas: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenda_tarefas_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      agenda_lembretes: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenda_lembretes_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agenda_lembretes_tarefa_id_fkey"
            columns: ["tarefa_id"]
            isOneToOne: false
      ...
      pomodoro_config_empresa: {
        Row: {
          ciclos_pausa_longa: number
          created_at: string
          empresa_id: string
          foco_min: number
        ...
        Relationships: [
          {
            foreignKeyName: "pomodoro_config_empresa_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: true
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      pomodoro_sessoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "pomodoro_sessoes_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pomodoro_sessoes_tarefa_id_fkey"
            columns: ["tarefa_id"]
            isOneToOne: false
            referencedRelation: "agenda_tarefas"
            referencedColumns: ["id"]
